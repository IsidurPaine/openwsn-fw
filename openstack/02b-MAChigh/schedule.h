...
#define SCHEDULE_MINIMAL_6TISCH_SLOTOFFSET                        1
#define SCHEDULE_MINIMAL_6TISCH_CHANNELOFFSET                     1
...
#define NUMSHAREDTXRX        2
#define NUMSERIALRX          1
#define NUMSLOTSOFF          1

#define NUMDATASLOT			 2
...
#define MAINTENANCESLOTNR	 (NUMADVSLOTS + NUMSHAREDTXRX + NUMSERIALRX)

#define MAXACTIVESLOTS       (SCHEDULE_MINIMAL_6TISCH_ACTIVE_CELLS + MAINTENANCESLOTNR + NUMSLOTSOFF)
