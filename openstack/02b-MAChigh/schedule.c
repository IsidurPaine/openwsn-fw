...
void schedule_init() {
	...
	for (running_slotOffset=start_slotOffset;running_slotOffset<NUMADVSLOTS;running_slotOffset++) {
	...
	for (running_slotOffset=start_slotOffset;running_slotOffset<NUMSHAREDTXRX;running_slotOffset++) {
		schedule_addActiveSlot(
				running_slotOffset,      // slot offset
